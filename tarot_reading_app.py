...
st.set_page_config(
		page_title= "Tarot Predict", # String or None. Strings get appended with "• Streamlit".
...
html_temp = """ 
    <div style ="background-color:dark;padding:13px"> 
    <h1 style ="color:white;text-align:center;">Tarot Predict App</h1> 
    </div> 
    """
...
if st.button("Get a Prediction"):  
		st.info('Please make sure what you want to predict in your mind for 10s')
		time.sleep(10)

		
		with open('back_music.mp3','rb') as f:
...
st.sidebar.info("This web app generates a tarot prediction of your past, present, and future.")
st.sidebar.info("Click on the 'Get a Prediction' button to generate a reading.")
st.sidebar.info("Start the music to have a greater experience,have fun!")
